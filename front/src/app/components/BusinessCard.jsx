...
export function BusinessCard({ business, onSelect, isSelected }) {
  return (
    <Card
      className={`cursor-pointer transition-all hover:shadow-lg focus:outline-none focus-visible:outline-none border-gray-200 ${isSelected ? 'ring-2 ring-blue-500' : ''
        }`}
    ...
    >
      ...
      <div className="p-4">
        ...
        {business.ai_reason && (
          <div className="mb-3 px-3 py-2 bg-purple-50 border border-purple-100 rounded-md">
            <div className="flex items-start gap-2">
              <Sparkles className="w-4 h-4 text-purple-600 mt-0.5 flex-shrink-0" />
              <p className="text-xs text-purple-800 italic leading-snug">
                {business.ai_reason}
              </p>
            </div>
          </div>
